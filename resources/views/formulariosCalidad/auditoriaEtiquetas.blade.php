                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="modal fade" id="miModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg"> <!-- Ajusta el tamaño del modal -->
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">TABLA PARA INSPECCIONJ NORMAL:
                                                        MUESTREO SIMPLE (MIL STD 105E)</h5>
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="muestra" id="muestra" placeholder="Ingresa Tamaño de Muestra" required title="Por favor, selecciona una opción"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="defecto" class="col-sm-3 col-form-label">DEFECTOS</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="defecto" id="defecto" placeholder="Ingresa Defecto" title="Por favor, selecciona una opción"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
